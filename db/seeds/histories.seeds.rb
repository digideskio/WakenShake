...
History.where(
  ...
  photo: open("#{Rails.root}/db/seeds/data/history_images/wns_2014.jpg")
)
History.where(
  ...
  photo: open("#{Rails.root}/db/seeds/data/history_images/wns_2013.jpg")
)
History.where(
  ...
  photo: open("#{Rails.root}/db/seeds/data/history_images/wns_2012.jpg")
)

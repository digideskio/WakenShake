...
class Dancer < ActiveRecord::Base
  ...
  validates_inclusion_of :first_time, message: "Indicate whether this is your first Wake 'N Shake or not", in: [true, false]
  validates_inclusion_of :vegetarian, message: "Indicate whether you are a vegetarian or not", in: [true, false]
